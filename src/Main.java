...
public class Main {
    ...
    public static void printDataFromCnp(String cnp) {
        ...
        System.out.println ( "Birthdate: " + getBirthDateFromCnp ( cnp ) );
        System.out.println ( "Age: " + calculateCurrentAge ( parseDateToInt ( getCurrentDate () ),
    ...
    public static int calculateCurrentAge(int[] currentDate, int[] birthDate) {
